...
public class PerInfo {
    ...
    public static void perInfo() {
        ...
        System.out.println("What's your highest level of education? (Choose one) "); // question to prompt input for
                                                                                     // education level
        ...
        while (!userChoice.equalsIgnoreCase("A") && !userChoice.equalsIgnoreCase("B")
                && !userChoice.equalsIgnoreCase("C") && !userChoice.equalsIgnoreCase("D")
                && !userChoice.equalsIgnoreCase("E") && !userChoice.equalsIgnoreCase("F")
                && !userChoice.equalsIgnoreCase("G") && !userChoice.equalsIgnoreCase("H")
                && !userChoice.equalsIgnoreCase("I")) {
        ...
        } else { // assigns a value to eduLevel if user's answer choice is not one of the given
                 // answers choices
            eduLevel = null;
        }
