...
public class Favorites 
{
    ...
    public Favorites(String nameSong, String nameGame, String nameBand, String nameFood, String nameCar, String nameSubject)
    {
        song = nameSong;
        game = nameGame;
        band = nameBand;
        ...
        String insert = "N/A";
         ...
         {
            //As a survey user, I want to be able to write in a favorite school subject if N/A is answered.
        ...
        //printing results 
        System.out.println("Your favorite song is " + song + ", your favorite game is " + game + ", your favorite band is " + band + ", your favorite type of food is " + food + ", your favorite car is " + car + ", your favorite subject is " + subject + ".");
