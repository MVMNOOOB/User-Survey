...
public class Pets
{
    public static void pets()
    {
        ...
        while(true)
        {
            ...
            //there is no pet
            if(petContinue1.equals("N/A") || petContinue1.equals("No") || petContinue1.equals("no") || petContinue1.equals("No.") || petContinue1.equals("no."))
            {
                petName = "N/A";
                petType = "N/A";
                petAge = "N/A";
            ...
            //done, moving on
            if(petContinue2.equals("Yes") || petContinue2.equals("yes") || petContinue2.equals("Yes.") || petContinue2.equals("yes."))
            {
